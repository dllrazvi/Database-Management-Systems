    ...
    public partial class Form1 : Form
    {
        ...
        private void addTransactionButton_Click(object sender, EventArgs e)
        {
            using (var conn = new SqlConnection("Data Source=DLLRAZVI;Initial Catalog=Blockchain;Integrated Security=True"))
            {
                ...
                cmd.Parameters.AddWithValue("@Sender", GetUserInput("Enter Sender Account ID:"));
                cmd.Parameters.AddWithValue("@Receiver", GetUserInput("Enter Receiver Account ID:"));
                cmd.Parameters.AddWithValue("@Block", GetUserInput("Enter Block ID:"));
                cmd.Parameters.AddWithValue("@Amount", GetUserInput("Enter Amount:"));
        ...
        using (var conn = new SqlConnection("Data Source=DLLRAZVI;Initial Catalog=Blockchain;Integrated Security=True"))
        {
            ...
            var cmdText = "UPDATE Transactions SET SenderAddress = @Sender, ReceiverAddress = @Receiver, BlockID = @Block, Amount = @Amount WHERE TransactionID = @TransactionID";
